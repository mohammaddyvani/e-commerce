                        ...
                        <ul class="nav myaccount-tab-trigger" id="account-page-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="account-details-tab" data-toggle="tab" href="#account-details"
                                    role="tab" aria-controls="account-details" aria-selected="false">Change Password</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content myaccount-tab-content" id="account-page-tab-content">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($transaction as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->created_at == null ? '-' : date('d M Y', strtotime($item->created_at)) }}
                                                        </td>
                                                        <td>
                                                            <ol>
                                                        ...
                                                        <td>
                                                            @if ($item->status == 'Packing')
                                                                ...
                                                                @method('delete')
                                                                @csrf
                                                                    <button class="uren-btn uren-btn_dark uren-btn_sm" type="submit">CANCEL</button>
                                                                </form>
                                                            @elseif ($item->status == 'Shipping')
                                                                <form action="{{ route('confirm-order', $item->id) }}" method="post">
                                                                    @csrf
                                                                    <button class="uren-btn uren-btn_dark uren-btn_sm" type="submit">ORDER CONFIRMATION</button>
                                                                </form>
                                                            @elseif ($item->status == 'Delivered')
                                                                    <button disabled="disabled" class="btn btn-secondary" style="width: 100%; height: 40px; font-size: 13px;">
                                                                        <span>RATE</span>
                                                                    </button>
                                                            @endif
                                                        </td>
                                ...
                                <div class="myaccount-address">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <address>
                                                {{ $defaultaddress->address . $default_address->city . $default_address->province . $default_address->postal_code}}
                                            </address>
                                        </div>
                                        <div class="col">
                            ...
                            <div class="tab-pane fade" id="account-details" role="tabpanel"
                                ...
                                <div class="myaccount-details">
                                    <form action="{{ route('changepassword') }}" class="uren-form" method="POST"
